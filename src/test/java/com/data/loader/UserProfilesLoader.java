...
public class UserProfilesLoader {
	...
	public static String getUserProfile(String... filterValues) throws FileNotFoundException, IOException {
		...
		return searchUserProfile(filterValues);

	}

	private static String searchUserProfile(String... filterValues) {
	...
	private static void loadData(String environment) throws FileNotFoundException {
		List<Object> yamlContent = YamlManager.readYaml(
				TestRunnerConstants.ACCESS_PROPERTIES_PATH + File.separator + "salesforce_user_profiles.yaml");
