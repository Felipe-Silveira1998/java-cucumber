...
public class AccountsLoader {
	...
	public static String getAccount(String... filterValues) throws FileNotFoundException, IOException {
		...
		return searchAccount(filterValues);

	}

	private static String searchAccount(String... filterValues) {
	...
	private static void loadData(String environment) throws FileNotFoundException {
		List<Object> yamlContent = YamlManager.readYaml(
				TestRunnerConstants.ACCESS_PROPERTIES_PATH + File.separator + "salesforce_accounts.yaml");
