...
public class TestRunnerConstants {
    ...
    public static final String CHROME_PROFILE_DIR = System.getProperty("user.dir")
            + File.separator + "chrome-profiles" + File.separator + "User Data" + File.separator + "selenium-profile";
    public static final String CUCUMBER_CONFIG_FILE_PATH = System.getProperty("user.dir") + File.separator + "src"
            + File.separator + "test" + File.separator + "java" + File.separator + "com" + File.separator + "java-cucumber"
            + File.separator + "core" + File.separator + "CucumberConfig.java";
    ...
    public static final String CONSULTATION_PROPERTIES_PATH = System.getProperty("user.dir") + File.separator + "data" + File.separator + "community_consultation" + File.separator + "consultation.properties";
